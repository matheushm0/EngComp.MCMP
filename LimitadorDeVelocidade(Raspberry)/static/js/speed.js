...
function setSpeed(speedM) {
  ...
  if (speedM > 1 && speedM < 70) {
   gear = 1;
	rpm = .8;
  } else if (speedM > 70 && speedM < 126) {
   gear = 2;
   rpm = .6;  
  } else if (speedM > 127 && speedM < 167) {
   gear = 3;
   rpm = .5;
  } else if (speedM > 168 && speedM < 225) {
   gear = 4;
   rpm = .6500;
  } else if (speedM > 226 && speedM < 287) {
   gear = 5;
   rpm = .6750;
  } else if (speedM > 288) {
   gear = 6;
  ...
  drawSpeedo(speedM, gear, rpm, 340);
